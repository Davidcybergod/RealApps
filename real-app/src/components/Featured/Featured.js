        ...
        <div className='featured'>
            ...
            <div className='container'>
                ...
                <div className='span-3 img-details'>
                    <div className='top'>
                        <h2>271 Mean Chey, Phnom Penh</h2>
                        <p>House for Sale</p>
                ...
                <div className='span-2 right-img-details'>
                    <p>A beautiful modern day home in the city with a full-size pool. Spacious and luxurious home located in Phnom Penh. Including media room, workout facility, and built-in sauna. </p>
